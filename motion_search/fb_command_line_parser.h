...
public:
  ...
  inline size_t NumFileNames(void) const { return m_fileNames.size(); }
...
private:
  void OnError(const char *pError) const { throw std::string(pError); }
...
CommandLineParser::Get<const std::string>(const char *const pName) const {
...
template <>
inline uint32_t
CommandLineParser::Get<uint32_t>(const char *const pName) const {
  return (uint32_t)Get<int32_t>(pName);
}

template <>
inline int32_t CommandLineParser::Get<int32_t>(const char *const pName,
...
template <>
inline uint32_t CommandLineParser::Get<uint32_t>(const char *const pName,
                                                 const uint32_t def) const {
  return (uint32_t)Get<int32_t>(pName, (int32_t)def);
}

template <>
inline double CommandLineParser::Get<double>(const char *const pName,
